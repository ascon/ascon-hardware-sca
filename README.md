...
Ascon has been selected as the primary choice for lightweight authenticated encryption in the final portfolio of the (CAESAR competition)[https://competitions.cr.yp.to/caesar.html] (2014-2019) and is currently competing as a finalist in the (NIST Lightweight Cryptography competition)[https://csrc.nist.gov/Projects/lightweight-cryptography/finalists] (2019-).
